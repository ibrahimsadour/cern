   ...
   ================================================== -->
	<header id="main-header">
   	<div class="row">
			...
			<div class="logo">
			<a href="index.php">Ibrahim Sadour</a>
			</div>
			<nav id="nav-wrap">         
...
<form action="signup.php" method="POST">
    ...
    <center><img src="fonts/sign-up-2314914_960_720.png" width="300" height="300"></center>
  </div>
  ...
  <div class="container">
	...
	<label for="email"><b><span style="color:yellow;"> Eamil </span></b></label>
    <input type="email" placeholder="Enter Email" name="email" required>
	
  
        
	<button type="submit" name="signup">Regestratie</button>
